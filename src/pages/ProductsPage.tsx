...
const ProductsPage = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Products | Job Portal, Digital Wallet & Chatbot Solutions - Devs Quest"
        description="Explore our comprehensive product suite: Job Portal, Close Loop Digital Wallet, Text Chatbot Agent, and Voice Chatbot Agent. Proven solutions with real case studies."
        keywords="job portal, digital wallet, chatbot, voice AI, recruitment platform, loyalty program, customer service automation"
        ...
        <div className="container relative z-10 px-6">
          ...
          >
            ...
            <p className="text-xl text-background/70 max-w-2xl mx-auto">
              Comprehensive product solutions with proven results.
                  ...
                  >
                    ...
                    <div className="p-4 rounded-xl bg-foreground/[0.02] border border-border/50 mb-6 relative z-10">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-xs text-muted-foreground">• {product.caseStudy.industry}</span>
                      </div>
                      <p className="text-sm font-medium text-foreground mb-3">{product.caseStudy.client}</p>
                      <div className="grid grid-cols-4 gap-2">
                        {product.caseStudy.metrics.map((metric) => (
        ...
        <div className="container px-6">
          ...
          >
            ...
            <p className="text-lg text-background/70 mb-8 relative z-10">
              Schedule a free consultation and let's discuss how our products can solve your challenges.
            </p>
            <a
